...
export const AMM_CURVES = {
  [Network.Porto]: {
    STABLE: `${PACKAGES[Network.Porto].DEX}::curves::Stable`,
    VOLATILE: `${PACKAGES[Network.Porto].DEX}::curves::Volatile`,
  },
  [Network.AptosTestnet]: {
    STABLE: `${PACKAGES[Network.AptosTestnet].DEX}::curves::Stable`,
    VOLATILE: `${PACKAGES[Network.AptosTestnet].DEX}::curves::Volatile`,
  },
};
